    ...
    <div className="space-y-12">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-8 border-b border-slate-100">
        <div className="space-y-2">
          <h1 className="text-4xl font-black text-slate-900 tracking-tight">Our Collection</h1>
          <p className="text-slate-500 font-medium">Discover {products.length} handpicked premium products.</p>
        </div>
          ...
          {products.map((p) => (
            ...
            >
              <div className="relative aspect-[4/5] overflow-hidden bg-slate-100">
                <img
                  src={p.imageUrl || 'https://images.unsplash.com/photo-1523275335684-37898b6baf30?q=80&w=1000&auto=format&fit=crop'}
                  alt={p.name}
              ...
              <div className="p-8 flex flex-col flex-1 gap-6">
                <div className="space-y-2">
                  ...
                  <p className="text-slate-500 text-sm font-medium line-clamp-2 leading-relaxed">
                    Designed for perfection. Experience the pinnacle of performance and style.
                  </p>
                </div>
